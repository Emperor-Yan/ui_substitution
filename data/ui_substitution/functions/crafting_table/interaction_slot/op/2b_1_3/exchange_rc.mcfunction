...
execute at @s positioned ~ ~.2 ~ on target run item replace entity @s weapon.mainhand from entity @e[limit=1,distance=..0.001,tag=material_display,tag=slot_1_3] container.0

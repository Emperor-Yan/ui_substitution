...
execute if score polished_blackstone_slab uis_craft_match matches 3 run data modify entity @s data.craft.result append value {item:"polished_blackstone_slab",Count:6b}

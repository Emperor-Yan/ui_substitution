...
#将材料槽位中的物品数量增加1
execute at @s positioned ~ ~.2 ~ as @e[limit=1,distance=..0.001,tag=material_display] positioned ~ ~-.2 ~ align xyz run function ui_substitution:crafting_table/interaction_slot/op/7b_3_2/add_1_rear

...
#更新槽位物品实际数量到Marker
execute at @s align xyz store result entity @e[limit=1,distance=..0.001,tag=uis_crafting_table,type=marker] data.material[{Slot:6b}].Item.Count int 1 run scoreboard players get @s uis_split_slot_item_count_act
